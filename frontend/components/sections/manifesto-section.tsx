  ...
  return (
    ...
    >
      <div className="max-w-5xl mx-auto relative">
        ...
        <motion.h2
          className="absolute inset-0 text-4xl md:text-6xl lg:text-7xl font-serif leading-tight text-center bg-gradient-to-r from-white via-gray-300 to-white bg-clip-text text-transparent"
          style={{ clipPath }}
        >
          Readable by Humans
          <br />
